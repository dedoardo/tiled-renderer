...
namespace camy
{
	namespace API
	{
		...
		void log_init()
		{
			impl::g_log_lock = API::futex_create();
		}

		void log_set_ostream(std::ostream* output_stream)
		{
			impl::g_log_ostream = output_stream;
		}

		std::ostream* log_get_ostream()
		{
			return impl::g_log_ostream;
		}
	}
}