...
namespace camy
{
    ...
    DynLinearBuffer::~DynLinearBuffer() { _deallocate(m_beg); }
    ...
    byte* DynLinearBuffer::cur() { return m_cur; }

    const byte* DynLinearBuffer::cur() const { return m_cur; }

    byte* DynLinearBuffer::data() { return m_beg; }

    const byte* DynLinearBuffer::data() const { return m_beg; }
    ...
    void DynLinearBuffer::clear() { m_cur = m_beg; }

    rsize DynLinearBuffer::count() const { return (rsize)(m_cur - m_beg); }

    rsize DynLinearBuffer::capacity() const { return (rsize)(m_end - m_beg); }

    bool DynLinearBuffer::empty() const { return m_cur == m_beg; }
    ...
    void DynLinearBuffer::_deallocate(byte* ptr) { API::deallocate(ptr); }
