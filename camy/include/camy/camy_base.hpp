...
#if !defined(camy_mode_test) || !defined(camy_mode_release) || !defined(camy_mode_final)
// Defaulting to test
...
#define camy_array_count(x) (sizeof((x)) / sizeof((x)[0]))
...
#include "camy_decls.hpp"

// Error utilities
#include "camy_error.hpp"
