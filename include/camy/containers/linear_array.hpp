...
namespace camy
{
    ...
    */
    ...
    inline LinearArray<ElementType, kElementCount, kAlignment>::LinearArray() : m_num_elements(0)
    {
    }
    ...
    template <typename ElementType, rsize kElementCount, uint16 kAlignment>
    inline const ElementType& LinearArray<ElementType, kElementCount, kAlignment>::
    operator[](rsize idx) const
    {
        assert(idx < m_num_elements);
        return m_buffer[idx];
    }
