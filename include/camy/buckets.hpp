...
#pragma pack(push, 1)
	...
	static_assert(sizeof(Parameter) == sizeof(void*) + 4, "Parameter not packed as expected. This assert can be removed even though it might be worth investigating the error");
#pragma pack(pop)
...
#pragma pack(push, 1)
	...
	static_assert(sizeof(ParameterBlock) == sizeof(void*) + 4, "ParameterBlock not packed as expected. This assert can be removed even though it might be worth investigating the error");
#pragma pack(pop)
